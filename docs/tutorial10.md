...
The input file used for this tutorial can be referenced in the *docs/tutorials/tutorial10/* directory as well as [here](https://github.com/hashkat/hashkat/blob/master/docs/tutorials/tutorial10/INFILE.yaml). This tutorial should take approximately 20 minutes to complete.
