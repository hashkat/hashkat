...
14. In order to run simulations using **#k@** anywhere on your computer, you must first edit the *.bashrc* file. You can enter this file
...
13. In order to run simulations using **#k@** anywhere on yur computer, you must first edit the *.bashrc* file. You can enter this file
by typing in the command:
